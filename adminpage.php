...
<body>
    ...
    <div class="side-menu">
        ...
        <ul>
            ...
            <li><a href="pelanggan.php"><i class="glyphicon glyphicon-user"></i></i>&nbsp; DATA CUSTOMER</li>
    ...
    <div class="right">
        <div class="info">
            ...
            <div class="info_data">
                 <div class="data">
                    <h4>Email</h4>
                    <p>badriainursakhis123@gmail.com</p>
                 </div>
                 <div class="data">
                   <h4>Phone</h4>
                    <p>087781943230</p>
      ...
      <div class="projects">
        ...
        <div class="social_media">
            <ul>
              ...
              <li><a href="https://api.whatsapp.com/send/?phone=%2B6287781943230&text&type=phone_number&app_absent=0"><i class='bx bxl-whatsapp'></i></a></li>
              <li><a href="https://www.instagram.com/badriainur/"><i class='bx bxl-instagram'></i></a></li>
          </ul>
      </div>
    </div>
</div>
